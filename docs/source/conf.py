...
# -*- coding: utf-8 -*-
#
# saxshell documentation build configuration file, created by  # noqa: E501
...
project = "saxshell"
copyright = "%Y, The University of Colorado Boulder in the City of Boulder"
...
modindex_common_prefix = ["saxshell"]
...
html_context = {
    "display_github": True,
    "github_user": "kewh5868",
    "github_repo": "saxshell",
    "github_version": "main",
...
basename = "saxshell".replace(" ", "").replace(".", "")
